...
class TOCTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "cell", for: indexPath) as! TOCTableViewCell
        cell.label.text = String(indexPath.item + 1) + ". " + chap![indexPath.item]
